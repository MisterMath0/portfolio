        ...
        <header className="text-left">
          <div className="flex flex-col items-start space-y-3">
            ...
            <p className="text-lg text-gray-600 mt-2 animate-slide-up-delayed group cursor-pointer">
              <span className="hover:scale-125 transition-transform duration-300 inline-block">🎨</span> {personalInfo.roles.student}% Student •
              <span className="hover:scale-125 transition-transform duration-300 inline-block">💻</span> {personalInfo.roles.engineer}% Indie Developer •
